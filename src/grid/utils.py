...
# ---------------------------------------------------------------------------
# Periodic table lookups — copied from iodata/periodic.py (theochem/iodata)
# ---------------------------------------------------------------------------
...
"""Mapping from atomic number (int) to element symbol (str)."""

sym2num: dict[str, int] = {v: k for k, v in num2sym.items()}
"""Mapping from element symbol (str) to atomic number (int)."""
