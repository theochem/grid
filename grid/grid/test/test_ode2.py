...
def test_hermite_overlap2():
    ...
    # symmetry
    assert hermite_overlap2(10, 2 * 5 + 0, False, 2 * 6 + 0, False) == hermite_overlap2(10,
                                                                                        2 * 6 + 0,
                                                                                        False,
                                                                                        2 * 5 + 0,
                                                                                        False)
    assert hermite_overlap2(10, 2 * 5 + 0, True, 2 * 6 + 0, True) == hermite_overlap2(10, 2 * 6 + 0,
                                                                                      True,
                                                                                      2 * 5 + 0,
                                                                                      True)
    # anti-symmetry
    assert hermite_overlap2(10, 2 * 5 + 0, False, 2 * 6 + 1, False) == -hermite_overlap2(10,
                                                                                         2 * 6 + 0,
                                                                                         False,
                                                                                         2 * 5 + 1,
                                                                                         False)
    assert hermite_overlap2(10, 2 * 5 + 0, True, 2 * 6 + 1, True) == -hermite_overlap2(10,
                                                                                       2 * 6 + 0,
                                                                                       True,
                                                                                       2 * 5 + 1,
                                                                                       True)
    # xmax
    assert 2 * hermite_overlap2(8, 2 * 0 + 0, False, 2 * 0 + 0, False) == hermite_overlap2(8,
                                                                                           2 * 4 + 0,
                                                                                           False,
                                                                                           2 * 4 + 0,
                                                                                           False)
    assert 2 * hermite_overlap2(8, 2 * 8 + 0, False, 2 * 8 + 0, False) == hermite_overlap2(8,
                                                                                           2 * 4 + 0,
                                                                                           False,
                                                                                           2 * 4 + 0,
                                                                                           False)
...
def check_solve_xexp(rtf, s=1.0):
    ...
    f = CubicSpline(4 * s * (1 + s * x) * np.exp(s * x), 4 * s ** 2 * (2 + s * x) * np.exp(s * x),
                    rtf)
